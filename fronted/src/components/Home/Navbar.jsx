...
const Navbar = () => {
    return (
        <nav className="flex flex-row items-center justify-between px-4 md:px-28 py-4 bg-green-800 dark:bg-green-800">
            <Link className="flex items-center text-2xl md:text-3xl mb-2 md:mb-0" to="/">
                ...
                <span className="text-neutral-900 font-bold">Code</span>
            </Link>
            <div className="flex flex-row items-center gap-2 md:gap-4">
                <Link
                    to="/login"
                    className="px-4 py-2 bg-neutral-900 hover:bg-neutral-800 rounded-md font-semibold transition-colors"
                >
                    Login
                </Link>
                <Link
